...
export default function AiPage() {
  ...
  return (
    <main className="flex flex-col bg-gradient-to-b p-4">
      <div className="flex-1 flex flex-col md:flex-row p-4 overflow-hidden gap-4">
        <div className="flex flex-1 max-w-full md:max-w-[calc(100%-19rem)]">
          <div className="w-full h-full flex flex-col rounded-lg border border-gray-800 bg-gray-900/30 backdrop-blur-sm overflow-hidden">
            <div
              ...
              className="flex-1 max-h-[calc(80vh-120px)] overflow-y-auto p-4 space-y-4"
            ...
            {isScrolled && (
              <Button
                className="fixed bottom-24 right-8 md:right-[calc(50%+9.5rem)] rounded-full shadow-lg bg-gray-800 hover:bg-gray-700"
                size="icon"
