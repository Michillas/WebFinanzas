...
function FinanceToolCard({
  ...
  >
    ...
    <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
      <CardTitle className="text-lg font-medium sm:text-xl">{title}</CardTitle>
...
export default function Page() {
  return (
  <main className="flex mt-8 flex-col items-center justify-center bg-background p-4 md:p-8">
    ...
    <div className="grid w-full max-w-5xl grid-cols-1 gap-4 sm:gap-6 sm:grid-cols-2 lg:grid-cols-3">
    ...
    <Link className="flex text-center border-2 border-secondary col-span-1 sm:col-span-2 lg:col-span-3 hover:scale-[1.02] transition-all duration-200 hover:border-primary/50 hover:bg-muted/50 p-2 rounded-lg bg-card" href="/dashboard">
      <div className="flex items-center justify-center w-full h-full">
      <div className="text-muted-foreground">-</div><div className=" text-lg sm:text-xl font-medium mx-1">Entrar a<span className="text-transparent bg-gradient-to-r from-[#c2ff94] to-primary bg-clip-text mx-1">FireBoard</span></div><div className="text-muted-foreground"> -</div>
      </div>
    </Link>
    </div>
  </main>
